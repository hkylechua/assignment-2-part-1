...
csv_files = ["data/Laying-Accelerometer.csv", "data/Sitting-Accelerometer.csv", "data/Standing-Accelerometer.csv", "data/Walking-Accelerometer.csv"]
activity_list = ["laying", "sitting", "standing","walking"]
